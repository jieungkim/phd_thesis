...
%%%%%%%%%%%%%% FROM MCSLOCK
\newcommand{\swaptail}[2]{\code{SWAP$\_$TAIL #1 #2}}
\newcommand{\castail}[1]{\code{CAS$\_$TAIL #1}}
\newcommand{\getnext}{\code{GET$\_$NEXT}}
\newcommand{\setnext}[1]{\code{SET$\_$NEXT #1}}
\newcommand{\getbusy}[1]{\code{GET$\_$BUSY #1}}
\newcommand{\setbusy}{\code{SET$\_$BUSY}}
\newcommand{\invalidmcsval}{\code{MCS\_TOTAL\_CPU}}
\newcommand{\rellock}{\code{REL$\_$LOCK}}
\newcommand{\waitlock}[1]{\code{WAIT$\_$LOCK #1}}
\newcommand{\mcsmboot}{\code{MMCSMBoot}}
\newcommand{\mmcslockintro}{\code{MMCSLockIntro}}
\newcommand{\mmcslockabsintro}{\code{MMCSLockAbsIntro}}
\newcommand{\mmcslockop}{\code{MMCSLockOp}}
\newcommand{\mqmcslockop}{\code{MQMCSLockOp}}
\newcommand{\mhmcslockop}{\code{MHMCSLockOp}}
