...
\newcommand{\mmcsbootfull}{\codeinmath{MMCSBoot}}
...
\newcommand{\hardwarelocalstep}[3]{{\codeinmath{LMach}_{{\codeinmath{CPU}}} \ {#1}\ {#2}\ {#3}}}
...
\newcommand{\hardwarestepkwd}{{{\codeinmath{Mach}_\codeinmath{mc}}}}
...
\newcommand{\oraclestepkwd}{{{\codeinmath{Mach}_{\codeinmath{hworacle}}}}}
...
\newcommand{\envstepkwd}{{\codeinmath{Mach}_{\codeinmath{env}}}}
...
\newcommand{\singlestepkwd}{{{\codeinmath{Mach}_{\codeinmath{si}}}}}
\newcommand{\singlestep}[5]{{\singlestepkwd_{[{#1}]}~{#2}~{#3}~{#4}~{#5}}}

\newcommand{\singlebigstepkwd}{{\codeinmath{Mach}_{\codeinmath{si\_big}}}}
...
\newcommand{\singlebigtwostepkwd}{{\codeinmath{Mach}_{\codeinmath{si\_big}'}}}
...
\newcommand{\singlelocalstepkwd}{{\codeinmath{LMach}_{\codeinmath{si}_{\codeinmath{local}}}}}
\newcommand{\singlelocalstep}[3]{{\singlelocalstepkwd~{#1}~{#2}~{#3}}}

\newcommand{\singlelogstepkwd}{{\codeinmath{LMach}_{\codeinmath{si}_{\codeinmath{log}}}}}
...
\newcommand{\singlesplitstepkwd}{{\codeinmath{Mach}_{\mathrm{split}}}}
\newcommand{\singlesplitstep}[5]{{\singlesplitstepkwd_{[{#1}]}~{#2}~{#3}~{#4}~{#5}}}

\newcommand{\singlereorderstepkwd}{{\codeinmath{Mach}_{\codeinmath{reorder}}}}
...
\newcommand{\separatelogstepkwd}{{\codeinmath{LMach}_{\separatelogtypekwd}}}
...
\newcommand{\singleseparatestepkwd}{{\codeinmath{Mach}_{\codeinmath{sep}}}}
