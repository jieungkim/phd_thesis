...
The verified version that we have made has a property that all lock node and variables are statically assigned.This is due to the properties of the framework that we have used for the verification. 
