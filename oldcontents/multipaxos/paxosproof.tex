...
\noindent
\begin{multicols}{2}
\lstinputlisting[numbers = left, language = C]{source_code/multipaxos/paxos_verify_example.c}
\end{multicols}
\end{minipage}
...
\lstinputlisting[numbers = left]{source_code/multipaxos/paxos_acceptor_case.v}
...
\lstinputlisting[numbers = left]{source_code/multipaxos/paxos_witness_definition.v}
...
\lstinputlisting[numbers = left]{source_code/multipaxos/nth_send.v}
