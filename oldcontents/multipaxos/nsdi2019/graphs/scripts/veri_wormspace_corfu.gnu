...
# ACTUAL PLOTTING
plot "../data/veri_wormspace_corfu.txt" every ::0::6 using ($1/1000):2 title 'Paxos-WOR' pt 6 lt 1, \
     "../data/veri_wormspace_corfu.txt" every ::7::12 using ($1/1000):2 title 'Chain-WOR' pt 8 lt 2,\
