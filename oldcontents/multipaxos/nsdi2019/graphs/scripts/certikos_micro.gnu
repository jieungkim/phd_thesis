...
# ACTUAL PLOTTING
plot file_in every ::0::3  using ($1/1000):2 pt 6 lt 1 title 'read', \
	file_in every ::4::7  using ($1/1000):2 pt 8 lt 2 title 'write', \
	file_in every ::8::13  using ($1/1000):2 pt 11 lt 3 title 'capture \& write'
