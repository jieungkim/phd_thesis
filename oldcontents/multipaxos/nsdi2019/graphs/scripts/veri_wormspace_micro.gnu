...
# ACTUAL PLOTTING
plot file_in every ::0::6  using ($1/1000):2 pt 2 lt 1 title 'read', \
	file_in every ::14::20  using ($1/1000):2 pt 6 lt 3 title 'write', \
	file_in every ::21::27  using ($1/1000):2 pt 11 lt 4 title 'capture \& write'
#	file_in every ::7::13  using ($1/1000):2 pt 8 lt 2 title 'capture', \
