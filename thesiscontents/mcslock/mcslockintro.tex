...
\jieung{Change the lowest layer name as MBoot (instead of MMCSBoot) to keep the consistency with CertiKOS chapter}

\jieung{This section is good now. But, proof reading should be required.}
