\jieung{Check the notations for list app and cons (and others) - those things should be consistent with the operators in previous sections / Change the lowest layer name as MBoot (instead of MMCSBoot) to keep the consistency with CertiKOS chapter}
