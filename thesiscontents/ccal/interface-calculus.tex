...
Due to this advantage of local machine model, local layer interfaces are the only place where we build layers with facilitating multiple libraries and generic proofs of the previous work for sequential programs~\cite{deepspec}. 
