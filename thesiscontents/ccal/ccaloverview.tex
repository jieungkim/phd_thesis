...
%Using them, the goal of $\ccalname$ with the example in Figure~\ref{fig:chapter:ccal:sec:ccal-overview:ticket_lock_example} is 
%providing atomic specifications for acquire lock and release lock functions in layer $L_1$. 
