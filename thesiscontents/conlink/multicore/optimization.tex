...
Querying the environmental context after each local step is subtle when defining the local layer interface;
...
The optimization first requires the new definition regarding the event and the log as well as 
...
%%%%%%%%%%5
\begin{figure}
\noindent\fbox{auxiliary function, valid log, and valid oracle for the global log:}
%
...
Proving the refinement between the evaluation on the single separate machine model and the 
