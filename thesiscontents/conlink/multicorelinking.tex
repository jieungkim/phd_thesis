...
On the other hand, the private operation does not generate any event, because it does not affect others' behavior at all. 
...
Three arguments parameterize them. \jieung{add more descriptions for them}
