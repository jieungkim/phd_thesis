...
The next part is how to connect the multithreaded linking framework with the concrete definition of  $\TSched$ in $\certikos$, $\codeinmath{PBThrd}$ in Section~\ref{chapter:certikos:sec:per-thread-modules}.
