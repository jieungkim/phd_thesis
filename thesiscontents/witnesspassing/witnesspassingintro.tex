...
%In addition, the witness can be used to reason about different distributed functions and can
%be composed to verify the properties of the entire distributed system. We provide
%multi-Paxos as the primary example.
...
%
%\jieung{In this chapter, I copied and pasted and slightly revised our PLDI submisison.  But, I will update this part continuously}%The witness can be used to reason about different distributed functions and can
%be composed to verify the properties of the entire distributed system. We provide
%multi-Paxos as the primary example